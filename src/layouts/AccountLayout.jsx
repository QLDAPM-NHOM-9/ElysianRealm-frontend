    ...
    <div className="bg-bg-secondary min-h-screen">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="relative h-48 md:h-64 rounded-b-2xl shadow-sm" style={{ backgroundImage: `url(${coverImageUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          {/* Nút Upload */}
          <button className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm text-text-primary text-sm font-medium py-2 px-3 rounded-lg flex items-center gap-2 shadow-sm hover:bg-white">
            <FiUpload />
            Upload new cover
          </button>
          ...
          <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 flex flex-col items-center">
            ...
            <h2 className="text-3xl font-bold text-text-primary mt-3">John Doe</h2>
            <p className="text-text-secondary">john.doe@gmail.com</p>
          </div>
        </div>

        {/* --- Phần Tab Navigation --- */}
        <div className="bg-bg-primary rounded-2xl shadow-sm mt-24">
          <nav className="flex justify-around border-b border-border-primary">
            ...
            <AccountTab to="/account/payment">Payment methods</AccountTab>
          </nav>
